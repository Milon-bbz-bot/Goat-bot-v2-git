...
role: 0,
category: "fun",
description: "Mention fix like your uid.js",
...
const x = canvas.width - userImageSize - 50; 
const y = (canvas.height / 2) - (userImageSize / 2); 
...
// আপনার চাওয়া অনুযায়ী মেসেজ বডি পরিবর্তন করা হয়েছে
